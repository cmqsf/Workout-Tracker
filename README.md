...
Edit 20.3.2026: Changed my mind, decided I needed to get better at auth stuff. Creating my own bearer token since I don't want to pay for Cognito for a personal project.
...
#### css
Going for a purple on black look. I am not a UX person, I will never be a UX person. 

#### index
I am not using react for this project as I don't feel ready to learn how to use react yet. May get to it later, may not. Gotta be honest, my skills and interests are more on the backend side of things. 
   
Fonts: I don't know anything about UX, and I don't know how to make my own fonts, so I'm using a fun font from google fonts.
